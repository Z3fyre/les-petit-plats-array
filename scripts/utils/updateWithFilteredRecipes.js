...
export const updateWithFilteredRecipes = (filteredRecipes, searchInput = "") => {

    const cardSection = document.querySelector('.card_section');
    const numberOfRecipes = document.querySelector('.recipes_count');
    
    if (!filteredRecipes.length) {
        cardSection.innerHTML = `<p>Aucune recette ne contient (${searchInput}) ,essayez avec tartes aux pommes .</p>`;
